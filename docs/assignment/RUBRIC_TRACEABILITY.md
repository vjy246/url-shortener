...
This document has moved to `docs/project/RUBRIC_TRACEABILITY.md`.

Use the project version for the latest content.

| Rubric Category | Weight | Evidence in Repository | Notes |
|---|---:|---|---|
| Problem Understanding & Engineering Reasoning | 15% | `docs/assignment/ASSIGNMENT_RESPONSE.md`, `docs/REQUIREMENTS.md` | Requirements normalized, assumptions/trade-offs documented |
...
| AI-Assisted Development Proficiency | 20% | `docs/assignment/AI_EXECUTION_LOG.md` | Prompting workflow, validation loops, ownership model |
...
| Communication & Ownership | 5% | `README.md`, `docs/INDEX.md`, `docs/assignment/*` | Clear runbook, setup guidance, rationale and limits |
